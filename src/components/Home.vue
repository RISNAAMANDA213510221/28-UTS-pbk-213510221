  ...
  <div class="Register">
    ...
    <form class="container" @submit.prevent="tambahKegiatan"> 
      <div>
        ...
        <span class="error" v-show="!kegiatan.npm">NPM harus diisi</span>
      </div>
      <div>
    ...
    <div>
      <label for="sort">Urutkan Kegiatan:</label>
      <select id="sort" v-model="sortBy" @change="sortKegiatan">
    ...
    <div class="footer1">
      <p>&copy; 2023 Risna Amanda</p>
      <a href="https://www.instagram.com/risnamanda_"> Instagram</a>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    sortKegiatan() {
      switch (this.sortBy) {
        case 'default':
          this.kegiatanList.sort((a, b) => a.done - b.done)
          break
        case 'a-z':
          this.kegiatanList.sort((a, b) => a.nama.localeCompare(b.nama))
          break
        case 'z-a':
          this.kegiatanList.sort((a, b) => b.nama.localeCompare(a.nama))
          break
        case 'done':
          this.kegiatanList.sort((a, b) => b.done - a.done)
          break
        default:
          break
      }
